...
class TestModerator:
    ...
    def test_method_update(self, client: DisqusAdminPanel) -> None:
        moderator = client.admin_services.moderator.update(
            is_active=True,
            is_admin=True,
            username="string",
        )
    ...
    def test_raw_response_update(self, client: DisqusAdminPanel) -> None:
        ...
        response = client.admin_services.moderator.with_raw_response.update(
            is_active=True,
            is_admin=True,
            username="string",
        )
    ...
    def test_streaming_response_update(self, client: DisqusAdminPanel) -> None:
        with client.admin_services.moderator.with_streaming_response.update(
            is_active=True,
            is_admin=True,
            username="string",
        ) as response :
    ...
    def test_method_list(self, client: DisqusAdminPanel) -> None:
        moderator = client.admin_services.moderator.list()
        assert_matches_type(object, moderator, path=['response'])

    @parametrize
    def test_raw_response_list(self, client: DisqusAdminPanel) -> None:

        response = client.admin_services.moderator.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: DisqusAdminPanel) -> None:
        with client.admin_services.moderator.with_streaming_response.list() as response :
            assert not response.is_closed
            assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
    ...
    def test_method_add(self, client: DisqusAdminPanel) -> None:
        moderator = client.admin_services.moderator.add(
            password="string",
            username="string",
        )
        assert_matches_type(object, moderator, path=['response'])
    ...
    def test_raw_response_add(self, client: DisqusAdminPanel) -> None:
        ...
        response = client.admin_services.moderator.with_raw_response.add(
            password="string",
            username="string",
        )
    ...
    def test_streaming_response_add(self, client: DisqusAdminPanel) -> None:
        with client.admin_services.moderator.with_streaming_response.add(
            password="string",
            username="string",
        ) as response :
            assert not response.is_closed
...
class TestAsyncModerator:
    ...
    async def test_method_update(self, async_client: AsyncDisqusAdminPanel) -> None:
        moderator = await async_client.admin_services.moderator.update(
            is_active=True,
            is_admin=True,
            username="string",
        )
    ...
    async def test_raw_response_update(self, async_client: AsyncDisqusAdminPanel) -> None:
        ...
        response = await async_client.admin_services.moderator.with_raw_response.update(
            is_active=True,
            is_admin=True,
            username="string",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncDisqusAdminPanel) -> None:
        async with async_client.admin_services.moderator.with_streaming_response.update(
            is_active=True,
            is_admin=True,
            username="string",
        ) as response :
    ...
    async def test_method_list(self, async_client: AsyncDisqusAdminPanel) -> None:
        moderator = await async_client.admin_services.moderator.list()
        assert_matches_type(object, moderator, path=['response'])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncDisqusAdminPanel) -> None:

        response = await async_client.admin_services.moderator.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncDisqusAdminPanel) -> None:
        async with async_client.admin_services.moderator.with_streaming_response.list() as response :
            assert not response.is_closed
            assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
    ...
    async def test_method_add(self, async_client: AsyncDisqusAdminPanel) -> None:
        moderator = await async_client.admin_services.moderator.add(
            password="string",
            username="string",
        )
        assert_matches_type(object, moderator, path=['response'])
    ...
    async def test_raw_response_add(self, async_client: AsyncDisqusAdminPanel) -> None:
        ...
        response = await async_client.admin_services.moderator.with_raw_response.add(
            password="string",
            username="string",
        )
    ...
    async def test_streaming_response_add(self, async_client: AsyncDisqusAdminPanel) -> None:
        async with async_client.admin_services.moderator.with_streaming_response.add(
            password="string",
            username="string",
        ) as response :
            assert not response.is_closed
